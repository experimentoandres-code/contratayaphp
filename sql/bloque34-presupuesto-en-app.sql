-- El mensaje del presupuesto se lee en castellano (no un código).
-- La ficha completa se ve en la app instalada.
...
update public.mensajes
   set texto = 'Te envié un presupuesto de mano de obra. Para verlo, abrí Contratá Ya desde la app instalada. ' || texto
 where texto like '[[cy-pre]]%'
   and texto not like 'Te envié un presupuesto%';

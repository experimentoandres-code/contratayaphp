...
| Panel | Portón `soy_admin`. Diez secciones, no las ocho que describe [[Panel admin]]. |
...
- No es “todo vive en el navegador”. Eso era la GUÍA de la demo. Hoy `sessionStorage` es caché de UI; la verdad está en Supabase. Ver [[Analisis de la documentacion]].
...
Hallazgos ordenados: [[05-Hallazgos]]. Inventario: [[04-Inventario]]. Superficies: [[02-Superficies]]. Invariantes de producto: [[Invariantes]].

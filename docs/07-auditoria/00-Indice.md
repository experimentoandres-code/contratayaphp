...
Copia de trabajo en el vault técnico. En Documentos del panel: carpeta `public/vault/Auditoria/` (local) y las mismas notas en `vault/Operacion/` en contrataya.pro.
...
2. Lectura de este vault y de `README.md` / `GUIA.md`.
3. Checklist de [[Invariantes]] y `AGENTS.md`.
...
- El esquema SQL de Supabase (no está versionado en el repo). Ver [[Tablas Supabase]].
...
Esas ausencias están marcadas en [[05-Hallazgos]] y [[06-Lanzamiento]]. Pendientes previos: [[Pendientes]].
